...
//} else {
//    $is_sale_tag = StockieSettings::show_sale_flash();
...
//}
//
//echo wp_kses($price, 'post');
?>
<!--</p>-->

<p class="<?php echo esc_attr( apply_filters( 'woocommerce_product_price_class', 'price' ) );?>" data-separator="<?php esc_attr_e(wc_get_price_decimal_separator()); ?>"> <?php echo $product->get_price_html(); ?></p>
