...
<div class="vc_row">
    <div class="vc_col-lg-8 vc_col-lg-push-2 vc_col-md-10 vc_col-md-push-1 vc_col-xs-12">
        <form class="woocommerce-form woocommerce-form-login login"
              method="post" <?php echo wp_kses($hidder_attr, 'default') ?>>
            ...
            <p class="form-row">
                <label class="woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme">
                    ...
                    <span><?php esc_html_e('Remember me', 'stockie'); ?></span>
                </label>
                <?php wp_nonce_field('woocommerce-login', 'woocommerce-login-nonce'); ?>
                <input type="hidden" name="redirect" value="<?php echo esc_url($redirect) ?>"/>
                <button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="login"
                        value="<?php esc_attr_e('Login', 'stockie'); ?>"><?php esc_html_e('Login', 'stockie'); ?></button>
            </p>
