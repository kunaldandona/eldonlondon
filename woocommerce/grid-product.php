...
if ($masonry_layout) {
	$animation_type = StockieSettings::get( 'woocommerce_animation_type', 'global' );
	$animation_effect = StockieSettings::get( 'woocommerce_animation_effect', 'global' );
	$columns_num = StockieSettings::get( 'woocommerce_products_on_page', 'global' );
	if (!$columns_num){
        $columns_num = 24;
    }
...
$quickview_btn = StockieSettings::get( 'quickview_button', 'global');

?>

<li <?php post_class( $li_class ); ?> data-product-item="true" data-lazy-item="true"<?php echo esc_attr($_anim_attrs) ?>>
