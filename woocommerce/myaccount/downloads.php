...
<h4 class="title"><?php esc_html_e( 'Downloads', 'stockie' ); ?></h4>
							...
							if ( has_action( 'woocommerce_account_downloads_column_' . $column_id ) ) {
								...
								switch ( $column_id ) {
									...
									case 'download-remaining' :
										echo is_numeric( $download['downloads_remaining'] ) ? esc_html( $download['downloads_remaining'] ) : esc_html__( '&infin;', 'stockie' );
										break;
										...
										<?php
											$actions = array(
												'download'  => array(
													...
													'name' => esc_html__( 'Download', 'stockie' ),
												),
											);
...
<?php else : ?>
	<div class="message-box message-box-primary message-download">
		<?php esc_html_e( 'No downloads available yet.', 'stockie' ); ?>
		<div class="close">
			<i class="ion ion-md-close brand-color-hover-i"></i>
		</div>
	</div>
<?php endif; ?>
